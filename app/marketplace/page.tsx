  ...
  return (
    <section className="mx-auto max-w-6xl px-5 py-12">
      <div className="flex flex-wrap items-end justify-between gap-4 mb-8">
        <div>
          <div className="text-stonk-green text-sm font-mono mb-1">// anvil nft amm</div>
          <h1 className="text-3xl sm:text-4xl font-black">The Trading Floor</h1>
          <p className="text-stonk-muted mt-1 text-sm">
            Live-style overview of the broker ecosystem. Figures are illustrative —
            wire this up to an on-chain indexer for real data.
          </p>
        </div>
        <BuyOnPons />
      </div>
        ...
        <div className="panel p-5 lg:col-span-2">
          ...
          <div className="overflow-x-auto no-scrollbar">
            <table className="w-full text-sm min-w-[420px]">
              <thead>
                <tr className="text-stonk-muted text-xs uppercase tracking-widest text-left font-mono">
